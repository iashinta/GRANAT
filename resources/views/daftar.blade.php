...
<html>
	...
	<title>Daftar &mdash; GrAnaT</title>
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner" style="background-image: url(images/h31.jpg)" data-stellar-background-ratio="0.5">
		<div class="overlay"></div>
		<div class="gtco-container">
			<div class="row row-mt-15em">
				<div class="col-md-7 mt-text text-left animate-box" data-animate-effect="fadeInUp">
					<h1>REGISTER<strong> NOW</strong></h1>	
					<h2>Join The Greatest Underground Music Contest Now</h2>
				</div>
			</div>
		</div>
	</header>
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<form action="/daftar">
						...
						<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="asal">Kota Asal</label>
								<input type="text" id="asal" class="form-control" placeholder="Kota Asal">
							</div>
						</div>
